...
(function ( $ ) {
	...
	var ORBIT = {
		...
		// Extending orbit to add an 'active' class for the current slide image
		currentSlide: function () {
			// Remove the active class from existing images
			$('.orbit-slide' ).removeClass('active');

			// Add active class to the new slide. $slides holds all the slides. activeSlide holds the index of the active slide.
