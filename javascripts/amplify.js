...
var amplify = global.amplify = {
	publish: function( topic ) {
		...
		if(subscriptions.hasOwnProperty('setMarker')) {
			if(subscriptions.setMarker.length) {
				if(subscriptions.setMarker.length > 1) {
					subscriptions.setMarker = subscriptions.setMarker.slice(0,1);
				}
			}
		}
